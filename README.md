...
After cleaning and saving the final data to the gold table in the lakehouse, the implementation was verified and can be reviewed from folder: **`Notebooks/04_Verify_Output.ipynb`**.